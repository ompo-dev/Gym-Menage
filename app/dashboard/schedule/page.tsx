    ...
    <div className="space-y-6">
        ...
        <Dialog open={isNewClassDialogOpen} onOpenChange={setIsNewClassDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[500px]">
            <DialogHeader>
              ...
              <DialogDescription>Preencha os dados da nova aula. Clique em salvar quando terminar.</DialogDescription>
            </DialogHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Visualize e gerencie todas as aulas programadas para a semana.</CardDescription>
        </CardHeader>
        <CardContent>
                  ...
                  {filteredClasses.length > 0 ? (
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground">Instrutor: {cls.instructor}</p>
                              </div>
                            </div>
                            <div className="flex items-center space-x-4">
                    ...
                    <div className="flex h-[200px] items-center justify-center rounded-md border border-dashed">
                      <div className="text-center">
                        ...
                        <p className="text-sm text-muted-foreground">Não há aulas agendadas para {day}.</p>
                        <Button
                          variant="outline"
                          className="mt-4"
                          onClick={() => {
